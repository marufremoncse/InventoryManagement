                            ...
                            <form enctype="multipart/form-data" action="{{route('user.update',$user->id)}}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="InputEmail1" name="email" placeholder="Email Address ex. abc@gmail.com" value="{{$user->email}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="file" class="custom-file-input" id="InputFile" name="image" value="{{$user->image}}">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
